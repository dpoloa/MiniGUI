...
def imagesMiniGUI():
    ...
    if app_theme == "light":
        return {
            "Host": "./images_00_03/laptop.png",
            "Switch": "./images_00_03/switch.png",
            "Router": "./images_00_03/router.png",
            "Link": "./images_00_03/cable.png",
            "Select": "./images_00_03/select.png",
            "Delete": "./images_00_03/delete.png"
        }
    else:
        return {
            "Host": "./images_00_03/laptop.png",
            "Switch": "./images_00_03/switch.png",
            "Router": "./images_00_03/router.png",
            "Link": "./images_00_03/cable_white.png",
            "Select": "./images_00_03/select_white.png",
            "Delete": "./images_00_03/delete_white.png"
        }
