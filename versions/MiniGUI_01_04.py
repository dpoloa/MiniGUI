...
class MiniGUI(QMainWindow):
    ...
    def accessNet(self):
        """Function to start/stop Mininet and update button accordingly"""
...
def imagesMiniGUI():
    ...
    if app_theme == "light":
        return {
            "Host": "./images_01_04/laptop.png",
            "Switch": "./images_01_04/switch.png",
            "Router": "./images_01_04/router.png",
            "Link": "./images_01_04/cable.png",
            "Select": "./images_01_04/select.png",
            "Delete": "./images_01_04/delete.png"
        }
    else:
        return {
            "Host": "./images_01_04/laptop.png",
            "Switch": "./images_01_04/switch.png",
            "Router": "./images_01_04/router.png",
            "Link": "./images_01_04/cable_white.png",
            "Select": "./images_01_04/select_white.png",
            "Delete": "./images_01_04/delete_white.png"
        }
